...
casdat<- dbFetch(dbSendQuery(con,
                ...
                where year >= 2013
                and year <= ", endyear, "
                and agency_species_code in (689,690,691,692)
...
norln<- dbFetch(dbSendQuery(con,
                ...
                and FMP_AREA = '",noquote(params$fmp),"'
                and SPECIES in (62, 63, 64, 65, 66, 67, 68, 69, 76, 78)
