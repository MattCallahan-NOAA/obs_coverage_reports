...
![Figure i. Map of Fisheries Management Plan subareas. Areas include the Aleutian Islands (AI), Bering Sea (BS), Western Gulf of Alaska (WGOA), Central Gulf of Alaska (CGOA), West Yakutat (WY), and East Yakutat (EY).](fmp_subarea.png)
...
ggplot() +
  geom_line(data=fig10propEM, aes(x=year, y=prop_em, color="Proportion EM"), size=1)+
