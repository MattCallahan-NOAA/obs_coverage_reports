...
biol_colors<-c("#575195","#1ECAD3","#93D500")
...
fig9a <- ggplot(fig9dat_a,aes(x=as.factor(year),y=n_length,fill=obs_source))+
  ...
  facet_grid(mgmt_area~.)+
    scale_color_manual(values=c("#00467f","#4C9C2E","#BC4700"))+
  scale_fill_manual(values=c("#00467f","#4C9C2E","#BC4700"))+
  scale_x_discrete(breaks = seq(startyear, endyear, by = 3))+
  scale_y_continuous(n.breaks=2)+
  theme_doc()
...
ggplot()+
  ...
  ylab("scaled lenghts/mt (red) and scaled proportion EM (black)")+
  xlab("")+
  theme_doc()+
