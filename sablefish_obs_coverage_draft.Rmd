...
ggplot() +
  geom_line(data=fig10propEM%>%filter(mgmt_area=='WGOA'), aes(x=year, y=prop_em, color="Proportion EM"), size=1)+
  geom_line(data=fig10lnmt%>%filter(mgmt_area=='WGOA'), aes(x=year, y=lratio/scale, color="Lengths/mt"), size=1)+
  facet_wrap(~mgmt_area, ncol=1)+
    #facet_wrap(~mgmt_area, ncol=1)+
